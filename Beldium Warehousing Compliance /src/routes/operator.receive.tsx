...
import { DemoDataBanner, Panel, StatusPill } from "@/components/compliance-ui";
import { useDemo } from "@/lib/demo/store";
import { STORAGE_HIERARCHY } from "@/lib/demo/data";
...
export const Route = createFileRoute("/operator/receive")({
  head: () => ({
    meta: [
