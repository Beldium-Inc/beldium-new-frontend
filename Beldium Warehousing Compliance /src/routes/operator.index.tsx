...
import { EXPIRING_DOCS, FACILITY_PROFILE, OPERATOR_DOCUMENTS, STORAGE_HIERARCHY } from "@/lib/demo/data";
    ...
    <AppShell
      ...
      actions={
        <Button asChild className="rounded-xl bg-link text-link-foreground hover:bg-link/90">
          <Link to="/operator/receive">Receive shipment</Link>
        </Button>
      }
    >
      <div className="space-y-6">
        ...
        <div className="grid gap-6 xl:grid-cols-3">
                ...
                {incoming.map((s) => (
                  <TableRow key={s.id}>
                    ...
                    <TableCell className="text-right">
                      <Link to="/operator/receive" className="text-sm font-medium text-link hover:underline">
                        Receive
                      </Link>
                    </TableCell>
                  </TableRow>
          ...
          <Panel title="Open incidents" description="Reported events under investigation." actions={
            <Button asChild variant="outline" className="rounded-xl"><Link to="/operator/incidents">Report</Link></Button>
          }>
        ...
        <Panel title="Expiring documents" description="Renew before expiry to avoid a compliance suspension." actions={
          <Button asChild variant="outline" className="rounded-xl"><Link to="/operator/documents">Document library</Link></Button>
        }>
