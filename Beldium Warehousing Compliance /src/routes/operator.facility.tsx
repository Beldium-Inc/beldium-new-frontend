...
import { Field, Panel, StatusPill } from "@/components/compliance-ui";
import { COMPANY_PROFILE, FACILITY_PROFILE } from "@/lib/demo/data";

export const Route = createFileRoute("/operator/facility")({
  head: () => ({
    meta: [
