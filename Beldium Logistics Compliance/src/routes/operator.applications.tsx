...
import { PageHeader, Panel, Pill, RiskBadge, StatusBadge } from "@/components/beldium/bits";
...
function ApplicationsRoute() {
  const isChild = useRouterState({
    select: (s) => s.location.pathname !== "/operator/applications" && s.location.pathname !== "/operator/applications/",
  });
...
function ApplicationsList() {
  ...
  return (
    <AppShell
      role="operator"
      breadcrumbs={[{ label: "Compliance Operations", to: "/operator" }, { label: "Applications" }]}
