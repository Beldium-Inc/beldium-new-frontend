...
import { KeyValue, PageHeader, Panel, Pill } from "@/components/beldium/bits";
import { useApp } from "@/lib/app-state";
import { PRIMARY_COMPANY_ID } from "@/lib/mock-data";

export const Route = createFileRoute("/partner/company")({
  head: () => ({
    meta: [
...
function CompanyPage() {
  ...
  return (
    <AppShell role="partner" breadcrumbs={[{ label: "Sahel Haulage & Minerals Ltd", to: "/partner" }, { label: "Company information" }]}>
