...
import { PageHeader, Panel, Pill, RiskBadge, ScoreBar } from "@/components/beldium/bits";
import { useApp } from "@/lib/app-state";

export const Route = createFileRoute("/operator/risk")({
  head: () => ({
    meta: [
...
function RiskPage() {
  ...
  return (
    <AppShell role="operator" breadcrumbs={[{ label: "Compliance Operations", to: "/operator" }, { label: "Risk assessment" }]}>
