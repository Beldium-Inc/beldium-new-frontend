...
import { PageHeader, Panel, Pill, ScoreBar } from "@/components/beldium/bits";
...
function ApplicationPage() {
  ...
  return (
    <AppShell role="partner" breadcrumbs={[{ label: "Sahel Haulage & Minerals Ltd", to: "/partner" }, { label: "Application progress" }]}>
