...
export const Route = createFileRoute("/regulator/expiring")({
  head: () => ({
    meta: [
...
function RegulatorExpiring() {
  ...
  return (
    <AppShell role="regulator" breadcrumbs={[{ label: "Regulatory Oversight", to: "/regulator" }, { label: "Expiring credentials" }]}>
