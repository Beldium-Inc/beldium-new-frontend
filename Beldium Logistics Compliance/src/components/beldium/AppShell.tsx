  ...
  operator: [
    {
      ...
      items: [
        ...
        { to: "/operator/applications", label: "Applications", icon: ClipboardList },
        { to: "/operator/risk", label: "Risk assessment", icon: Gauge },
        { to: "/operator/documents", label: "Expiring documents", icon: FileClock },
        { to: "/operator/requests", label: "Information requests", icon: MessageSquareWarning },
      ],
    },
    {
      group: "Governance",
      items: [
        { to: "/operator/audit", label: "Audit history", icon: History },
        { to: "/operator/reports", label: "Reports", icon: PieChart },
        { to: "/operator/notifications", label: "Notifications", icon: Bell },
        { to: "/operator/profile", label: "My profile", icon: UserCircle },
      ],
    },
  ],
  partner: [
    {
      ...
      items: [
        ...
        { to: "/partner/application", label: "Application progress", icon: ClipboardList },
        { to: "/partner/requests", label: "Information requests", icon: MessageSquareWarning },
        { to: "/partner/company", label: "Company information", icon: Building2 },
      ],
    },
    {
      group: "Operations",
      items: [
        { to: "/partner/fleet", label: "Fleet", icon: Truck },
        { to: "/partner/drivers", label: "Drivers", icon: Users },
        { to: "/partner/documents", label: "Documents", icon: FileText },
        { to: "/partner/activity", label: "Activity", icon: History },
      ],
    },
  ],
  regulator: [
    {
      group: "Oversight",
      items: [
        { to: "/regulator", label: "Overview", icon: LayoutDashboard, exact: true },
        { to: "/regulator/operators", label: "Registered operators", icon: Building2 },
        { to: "/regulator/compliance", label: "Compliance status", icon: Gauge },
        { to: "/regulator/expiring", label: "Expiring credentials", icon: FileClock },
      ],
    },
    {
      group: "Intelligence",
      items: [
        { to: "/regulator/alerts", label: "Regulatory alerts", icon: ShieldAlert },
        { to: "/regulator/reports", label: "Reports", icon: PieChart },
        { to: "/regulator/notifications", label: "Notifications", icon: Bell },
      ],
    },
  ],
  admin: [
    {
      group: "Platform",
      items: [
        { to: "/admin", label: "Admin overview", icon: Settings, exact: true },
      ],
    },
  ],
};
      ...
      <div className="lg:pl-64">
        <header className="sticky top-0 z-30 border-b border-border bg-white/85 backdrop-blur">
          <div className="flex items-center gap-3 px-4 py-3 sm:px-6">
            ...
            <Link
              to={role === "operator" ? "/operator/notifications" : role === "partner" ? "/partner" : role === "regulator" ? "/regulator/notifications" : "/admin"}
