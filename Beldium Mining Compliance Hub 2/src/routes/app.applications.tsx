...
export const Route = createFileRoute("/app/applications")({ component: Page });

function Page() {
  return (
    <>
      <PageHeader title="Applications" description="Prototype screen. Data is seeded locally for the Beldium demo." />
