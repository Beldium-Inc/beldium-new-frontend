...
export const roleCatalogue: {
  ...
  {
    role: "compliance-org",
    title: "Mining Compliance Organisation",
    blurb:
      "An independent organisation providing mining compliance, verification, inspection, environmental, regulatory or technical assessment services.",
  ...
  },
  {
    ...
    title: "Mining Compliance Officer",
  ...
  {
    role: "independent",
    title: "Independent Mining Compliance Professional",
    blurb: "An individual professional providing eligible mining compliance services independently.",
