...
import { AppShell, Button, DemoNote, Metric, SectionCard } from "@/components/AppShell";
import { StatusBadge } from "@/components/StatusBadge";
import { fmtUsd, useDemo } from "@/lib/store";
import type { FinancePackage } from "@/lib/demo-data";
