...
export const Route = createFileRoute("/mining/documents")({ component: Page });

function Page() {
  return (
    <>
      <PageHeader title="Documents & Licences" description="Prototype screen. Data is seeded locally for the Beldium demo." />
      ...
      <Panel title="Documents & Licences">
