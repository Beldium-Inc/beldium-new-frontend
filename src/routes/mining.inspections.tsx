...
export const Route = createFileRoute("/mining/inspections")({ component: Page });

function Page() {
  return (
    <>
      <PageHeader title="Inspections" description="Prototype screen. Data is seeded locally for the Beldium demo." />
