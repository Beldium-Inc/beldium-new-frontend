...
export const Route = createFileRoute("/mining/reports")({ component: Page });

function Page() {
  return (
    <>
      <PageHeader title="Reports" description="Prototype screen. Data is seeded locally for the Beldium demo." />
