...
export const Route = createFileRoute("/mining/inventory")({ component: Page });

function Page() {
  return (
    <>
      <PageHeader title="Inventory" description="Prototype screen. Data is seeded locally for the Beldium demo." />
