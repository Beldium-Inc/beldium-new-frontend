...
import { CERTIFICATES, FACILITIES } from "@/verticals/warehousing/data";
      ...
      <div className="space-y-6">
        ...
        <div className="grid gap-6 xl:grid-cols-3">
          <Panel className="xl:col-span-2" title="Registered facilities" description="Status is maintained by the compliance partner." actions={
            <Link to="/warehousing/regulator/facilities" className="text-sm font-medium text-link hover:underline">View register</Link>
          }>
            <Table>
              <TableHeader>
                <TableRow>
        ...
        <div className="grid gap-6 xl:grid-cols-2">
          <Panel title="Certificates" description="Issued registration certificates and scope." actions={
            <Link to="/warehousing/regulator/certificates" className="text-sm font-medium text-link hover:underline">All certificates</Link>
          }>
            <ul className="space-y-3">
          ...
          <Panel title="Recent incidents" description="Operator-reported events across the register." actions={
            <Link to="/warehousing/regulator/incidents" className="text-sm font-medium text-link hover:underline">All incidents</Link>
          }>
            <ul className="space-y-3">
