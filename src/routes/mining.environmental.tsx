...
export const Route = createFileRoute("/mining/environmental")({ component: Page });

function Page() {
  return (
    <>
      <PageHeader title="Environmental & Safety" description="Prototype screen. Data is seeded locally for the Beldium demo." />
      ...
      <Panel title="Environmental & Safety">
