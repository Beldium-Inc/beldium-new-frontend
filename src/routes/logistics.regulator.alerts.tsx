...
export const Route = createFileRoute("/logistics/regulator/alerts")({
  head: () => ({
    meta: [
...
function RegulatorAlerts() {
  ...
  return (
    <AppShell role="regulator" breadcrumbs={[{ label: "Regulatory Oversight", to: "/logistics/regulator" }, { label: "Regulatory alerts" }]}>
