...
export const Route = createFileRoute("/mining/transactions")({ component: Page });

function Page() {
  return (
    <>
      <PageHeader title="Transactions" description="Prototype screen. Data is seeded locally for the Beldium demo." />
