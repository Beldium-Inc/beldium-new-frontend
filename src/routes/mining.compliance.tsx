...
export const Route = createFileRoute("/mining/compliance")({ component: Page });

function Page() {
  return (
    <>
      <PageHeader title="Compliance" description="Prototype screen. Data is seeded locally for the Beldium demo." />
