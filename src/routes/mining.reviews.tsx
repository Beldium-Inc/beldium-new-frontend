...
export const Route = createFileRoute("/mining/reviews")({ component: Page });

function Page() {
  return (
    <>
      <PageHeader title="Pending Reviews" description="Prototype screen. Data is seeded locally for the Beldium demo." />
