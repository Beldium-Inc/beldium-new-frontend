...
import { EmptyState, PageHeader, Stat, StatusPill, Surface, SectionTitle } from "@/verticals/quality/ui";
import { useBeldium } from "@/verticals/quality/store";

export const Route = createFileRoute("/quality/certificates/")({
  head: () => ({
    meta: [
