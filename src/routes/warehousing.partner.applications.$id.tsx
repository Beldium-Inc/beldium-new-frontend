...
import { DemoDataBanner, Field, Panel, StatusPill, toneForStatus } from "@/verticals/warehousing/compliance-ui";
import {
  ...
  type EvidenceState,
  type ReviewStatus,
} from "@/verticals/warehousing/data";
...
function ApplicationDetail() {
  const { id } = useParams({ from: "/warehousing/partner/applications/$id" });
  const {
    applications,
    decisions,
    recordDecision,
    ...
    <AppShell
      ...
      actions={
        <Button asChild variant="outline" className="rounded-xl">
          <Link to="/warehousing/partner/applications">
