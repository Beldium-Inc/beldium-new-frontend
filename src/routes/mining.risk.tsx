...
export const Route = createFileRoute("/mining/risk")({ component: Page });

function Page() {
  return (
    <>
      <PageHeader title="Risk" description="Prototype screen. Data is seeded locally for the Beldium demo." />
