...
export const Route = createFileRoute("/mining/audit")({ component: Page });

function Page() {
  return (
    <>
      <PageHeader title="Audit Trail" description="Prototype screen. Data is seeded locally for the Beldium demo." />
