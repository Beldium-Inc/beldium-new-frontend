...
import { PageHeader, Panel, Pill, ReadOnlyNotice, StatusBadge } from "@/verticals/logistics/bits";
import { useApp } from "@/verticals/logistics/store";

export const Route = createFileRoute("/logistics/regulator/operators")({
  head: () => ({
    meta: [
...
function RegulatorOperators() {
  ...
  return (
    <AppShell
      role="regulator"
      breadcrumbs={[{ label: "Regulatory Oversight", to: "/logistics/regulator" }, { label: "Registered operators" }]}
