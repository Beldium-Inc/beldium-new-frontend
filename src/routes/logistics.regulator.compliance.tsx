...
import { PageHeader, Panel, ReadOnlyNotice, ScoreBar } from "@/verticals/logistics/bits";
import { useApp } from "@/verticals/logistics/store";

export const Route = createFileRoute("/logistics/regulator/compliance")({
  head: () => ({
    meta: [
...
function RegulatorCompliance() {
  ...
  return (
    <AppShell role="regulator" breadcrumbs={[{ label: "Regulatory Oversight", to: "/logistics/regulator" }, { label: "Compliance status" }]}>
