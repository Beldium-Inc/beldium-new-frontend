...
import { licences, organisations, samples } from "@/verticals/mining/data";
  ...
  if (!site) {
    return (
      <Panel title="Site not found">
        ...
        <Button asChild className="mt-4" variant="outline"><Link to="/mining/sites">Back to sites</Link></Button>
      </Panel>
    );
  }
      ...
      <div className="mt-5 grid gap-5 xl:grid-cols-[minmax(0,1.6fr)_minmax(0,1fr)]">
        ...
        <div className="space-y-5">
          ...
          <Panel title="Non-conformities" bodyClassName="p-0">
            ...
            <div className="px-5 py-4"><Button asChild size="sm" variant="outline"><Link to="/mining/nonconformities">Open non-conformity tracking</Link></Button></div>
          </Panel>
        </div>
      </div>
      {infoFor ? (
