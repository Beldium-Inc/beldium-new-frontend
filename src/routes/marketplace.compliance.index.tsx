...
import { AppShell, Metric, SectionCard } from "@/verticals/marketplace/AppShell";
import { StatusBadge } from "@/verticals/marketplace/StatusBadge";
import { Input } from "@/components/ui/input";
import { fmtDate, fmtUsd, useDemo } from "@/verticals/marketplace/store";
import type { AppStatus } from "@/verticals/marketplace/demo-data";
import { cn } from "@/lib/utils";

export const Route = createFileRoute("/marketplace/compliance/")({
  head: () => ({
    meta: [
