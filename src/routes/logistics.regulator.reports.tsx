...
export const Route = createFileRoute("/logistics/regulator/reports")({
  head: () => ({
    meta: [
...
function RegulatorReports() {
  return (
    <AppShell role="regulator" breadcrumbs={[{ label: "Regulatory Oversight", to: "/logistics/regulator" }, { label: "Reports" }]}>
