...
import { AppShell, SectionCard } from "@/verticals/marketplace/AppShell";
import { StatusBadge } from "@/verticals/marketplace/StatusBadge";
import { fmtTonnes, fmtUsd, useDemo } from "@/verticals/marketplace/store";

export const Route = createFileRoute("/marketplace/offers")({
  head: () => ({
    meta: [
