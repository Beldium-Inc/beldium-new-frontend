...
export const Route = createFileRoute("/mining/actions")({ component: Page });

function Page() {
  return (
    <>
      <PageHeader title="Action Required" description="Prototype screen. Data is seeded locally for the Beldium demo." />
