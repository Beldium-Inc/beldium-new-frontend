...
import { envRecords, licences, organisations, safetyIncidents } from "@/verticals/mining/data";
                ...
                {sites.map((s) => {
                  ...
                  return (
                    <TableRow key={s.id}>
                      ...
                      <TableCell className="text-right">
                        <div className="flex flex-wrap justify-end gap-1.5">
                          <Button asChild size="sm" variant="ghost"><Link to="/mining/sites/$siteId" params={{ siteId: s.id }}>View status</Link></Button>
