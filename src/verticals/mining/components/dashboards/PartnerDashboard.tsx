        ...
        actions={
          <>
            <Button asChild variant="outline">
              <Link to="/mining/reviews">
                <ClipboardList className="size-4" /> Review queue
              </Link>
            </Button>
            <Button asChild>
              <Link to="/mining/sites/$siteId" params={{ siteId: "NL-024" }}>
                Open NL-024 review
              </Link>
            </Button>
          </>
        ...
        <Panel
          ...
          actions={
            <Button asChild variant="ghost" size="sm">
              <Link to="/mining/reviews">View all</Link>
            </Button>
          }
          bodyClassName="p-0"
        >
                ...
                {awaiting.map((n) => (
                  <li key={n.id} className="px-5 py-3.5">
                    ...
                    <Button asChild size="sm" variant="outline" className="mt-2">
                      <Link to="/mining/nonconformities">Review submission</Link>
                    </Button>
                  </li>
                ))}
              </ul>
