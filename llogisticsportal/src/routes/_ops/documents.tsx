...
export const Route = createFileRoute("/_ops/documents")({
  validateSearch: tabSearch,
  head: () => ({
    meta: [
      { title: "Document Register | Beldium Logistics" },
      { name: "description", content: "Organisation, vehicle, driver and movement documents with verification and expiry status." },
      { property: "og:title", content: "Document Register | Beldium Logistics" },
