...
export const Route = createFileRoute("/_ops/routes-tracking")({
  head: () => ({
    meta: [
      { title: "Routes & Tracking | Beldium Logistics" },
      { name: "description", content: "Live GPS tracking of Beldium movements with progress, ETA, stops, delays and route deviations." },
      { property: "og:title", content: "Routes & Tracking | Beldium Logistics" },
