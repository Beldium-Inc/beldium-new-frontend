...
export const Route = createFileRoute("/_ops/vehicles")({
  validateSearch: tabSearch,
  head: () => ({
    meta: [
      { title: "Vehicles | Beldium Logistics" },
      { name: "description", content: "Vehicle register with insurance, roadworthiness and compliance documents per vehicle." },
      { property: "og:title", content: "Vehicles | Beldium Logistics" },
          ...
          <>
            ...
            <Btn
              ...
              onClick={() => {
                ...
                setAdd(false);
                navigate({ to: "/vehicles/$vehicleId", params: { vehicleId: id } });
              }}
            >
              Submit Vehicle
            </Btn>
