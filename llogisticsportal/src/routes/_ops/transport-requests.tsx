...
export const Route = createFileRoute("/_ops/transport-requests")({
  validateSearch: tabSearch,
  head: () => ({
    meta: [
      { title: "Transport Requests | Beldium Logistics" },
      ...
      { property: "og:title", content: "Transport Requests | Beldium Logistics" },
...
function Page() {
  ...
  const open = (r: TransportRequest) => navigate({ to: "/transport-requests/$requestId", params: { requestId: r.id } });
  return (
    <>
