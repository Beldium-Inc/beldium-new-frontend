...
export const Route = createFileRoute("/_ops/bulk-logistics")({
  validateSearch: tabSearch,
  head: () => ({
    meta: [
      { title: "Bulk Mineral Logistics | Beldium Logistics" },
      ...
      { property: "og:title", content: "Bulk Mineral Logistics | Beldium Logistics" },
