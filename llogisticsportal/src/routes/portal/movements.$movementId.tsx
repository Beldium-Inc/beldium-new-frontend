...
export const Route = createFileRoute("/portal/movements/$movementId")({
  head: ({ params }) => ({
    meta: [
      { title: `${params.movementId} | Movement - Beldium Logistics Hub` },
      ...
      { property: "og:title", content: `${params.movementId} - Beldium Logistics Hub` },
  ...
  if (!m) {
    return (
      <Panel title="Movement not found">
        <Link to="/portal/active-movements" className="text-sm font-semibold text-colorLink">
