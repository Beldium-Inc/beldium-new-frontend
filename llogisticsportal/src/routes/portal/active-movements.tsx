...
export const Route = createFileRoute("/portal/active-movements")({
  validateSearch: tabSearch,
  head: () => ({
    meta: [
      { title: "Active Movements - Beldium Logistics Hub" },
      { name: "description", content: "Every Beldium movement by stage with vehicle, driver, route, ETA and linked transaction." },
      { property: "og:title", content: "Active Movements - Beldium Logistics Hub" },
