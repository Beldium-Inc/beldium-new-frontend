  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="flex min-h-screen w-full flex-col lg:flex-row">
        <aside className="relative hidden w-full flex-col justify-between overflow-hidden bg-sidebar p-10 lg:flex lg:w-2/5 xl:w-1/3">
          ...
          <div className="relative space-y-5 text-sidebar-foreground">
            <h2 className="text-3xl leading-tight font-semibold">
              Mineral movement you can trust.
            </h2>
            <p className="text-sm text-sidebar-foreground/75">
              Register your logistics organisation, fleet and drivers, get verified by Beldium
              Logistics Compliance, then run transport requests, movements and deliveries from one
              operator workspace.
            </p>
            <ul className="space-y-2 text-sm text-sidebar-foreground/75">
              <li>* Role based operator and organisation access</li>
              <li>* Fleet, driver and document application with saved progress</li>
