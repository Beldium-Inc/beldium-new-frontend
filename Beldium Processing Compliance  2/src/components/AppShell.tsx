...
import { Pill } from "@/components/bpc";
...
const OPERATOR_NAV: { group: string; items: NavItem[] }[] = [
  {
    ...
    items: [
      ...
      { to: "/app/applications", label: "Applications", icon: FileStack, badge: "5" },
      { to: "/app/nonconformities", label: "Non-conformities", icon: AlertTriangle, badge: "3" },
      { to: "/app/inspections", label: "Inspections", icon: ClipboardCheck },
      { to: "/app/onboarding", label: "New Application", icon: ScrollText },
    ],
  },
  {
    group: "Context",
    items: [
      { to: "/app/traceability", label: "Operational Traceability", icon: Boxes },
...
const REGULATOR_NAV: { group: string; items: NavItem[] }[] = [
  {
    ...
    items: [
      { to: "/app/dashboard", label: "Dashboard", icon: LayoutDashboard },
      { to: "/app/processors", label: "Processors & Facilities", icon: Factory },
      { to: "/app/monitoring", label: "Compliance Monitoring", icon: Gauge },
      { to: "/app/inspections", label: "Inspection Queue", icon: ClipboardCheck },
    ],
  },
  {
    group: "Signals",
    items: [
      { to: "/app/environmental", label: "Environmental Alerts", icon: Leaf, badge: "2" },
      { to: "/app/incidents", label: "Incidents", icon: Siren },
      { to: "/app/nonconformities", label: "Non-conformities", icon: AlertTriangle },
    ],
  },
  {
    group: "Records",
    items: [
      ...
      { to: "/app/audit", label: "Audit History", icon: History },
      { to: "/app/traceability", label: "Operational Traceability", icon: Boxes },
    ],
  },
];
