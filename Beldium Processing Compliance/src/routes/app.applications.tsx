...
import { Panel, PageHeader, Pill, RiskBadge, ScoreBar, statusTone } from "@/components/bpc";
import { useAppState } from "@/lib/app-state";
import { processingTypeLabel } from "@/lib/mock-data";
...
function ApplicationsLayout() {
  ...
  if (pathname !== "/app/applications") return <Outlet />;
