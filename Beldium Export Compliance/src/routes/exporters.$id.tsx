...
import { DisclaimerNote, DocStatusPill, Panel, Pill, ScoreBar, ShipmentStatusPill } from "@/components/ui-kit";
import { Button } from "@/components/ui/button";

export const Route = createFileRoute("/exporters/$id")({
  head: () => ({
    meta: [
  ...
  if (!e)
    return (
      <AppShell title="Exporter not found">
        <Panel>
          <Button asChild>
            <Link to="/exporters">Back to exporters</Link>
          </Button>
        </Panel>
      </AppShell>
    );
